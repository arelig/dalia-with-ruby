...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference("Plant.count") do
      post plants_url, params: { plant: { category: @plant.category, last_watered: @plant.last_watered, name: @plant.name } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { category: @plant.category, last_watered: @plant.last_watered, name: @plant.name } }
